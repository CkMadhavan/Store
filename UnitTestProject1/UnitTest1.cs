...
namespace Supermarket.UnitTests
{
    ...
    public class SupermarketTest
    {
        ...
        [TestMethod]
        public void totalPrice_DiscountNotEligible_508()
        {
            // Arrange
            List<string> skus = new List<string>();
            Dictionary<string, int> prices = new Dictionary<string, int>();
            ...
            skus_to_buy = new List<string>() { "A99", "B15","T34",  "A99", "T34", "C40", "C40", "C40" };
            ...
            // Assert
            Assert.AreEqual(total, 508);  // 2*50 (A99) + 1*30 (B15) + 3*60 (C40) + 2*99 (T34) = 508
        }
